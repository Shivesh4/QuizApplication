      ...
      <div class="-quiz-instructions-container">
        ...
        <div id="id01" class="modal">
            ...
            <div class="container11">
                ...
                <p>Intuit</p>
                <p><b>Question</b><p>
                <p> What tag is used to create a button?</p>
                <p><b>Options</b><p>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr id="qid01">
                          ...
                          <td>2.846</td>
                          <td>
                            <button onclick="document.getElementById('id01').style.display='block'" type="button" class="btn btn-primary">View</button>
                        ...
                        <tr id="qid01">
                          ...
                          <td>2.846</td>
                          <td>
                            <button onclick="document.getElementById('id01').style.display='block'" type="button" class="btn btn-primary">View</i></button>
                          </td>
                        </tr>
                      </tbody>
                    </table>
